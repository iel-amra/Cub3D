...
/*   Updated: 2022/07/25 18:30:45 by glemoine         ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
static int	nb_flags(const char *str)
{
	int		i;
	char	*charset;
...
static int	valid_flags(char *flags)
{
	char	*v_flags;
...
static int	print_var(char c, va_list args, char *flags, int fd)
{
	int	len;
...
static int	print_var_if_charset(const char **str, va_list args, int fd)
{
	char	*charset;
	char	*flags;
	int		count;
